...
if ( ! function_exists( 'planet3_0_content_nav' ) ) :
/**
 * Display navigation to next/previous pages when applicable
 *
 * @since Planet3.0 3.0
 */
function planet3_0_content_nav( $nav_id ) {
	...
	<nav role="navigation" id="<?php echo esc_attr( $nav_id ); ?>" class="<?php echo $nav_class; ?>">
		<h1 class="screen-reader-text"><?php _e( 'Post navigation', 'planet3_0' ); ?></h1>
...
endif; // planet3_0_content_nav

if ( ! function_exists( 'planet3_0_comment' ) ) :
/**
 ...
 * @since Planet3.0 3.0
 */
function planet3_0_comment( $comment, $args, $depth ) {
...
endif; // ends check for planet3_0_comment()

if ( ! function_exists( 'planet3_0_posted_on' ) ) :
/**
 ...
 * @since Planet3.0 3.0
 */
function planet3_0_categorized_blog() {
	...
	if ( '1' != $all_the_cool_cats ) {
		// This blog has more than 1 category so planet3_0_categorized_blog should return true
		return true;
	} else {
		// This blog has only 1 category so planet3_0_categorized_blog should return false
		return false;
	}
}

/**
 * Flush out the transients used in planet3_0_categorized_blog
 *
 * @since Planet3.0 3.0
 */
function planet3_0_category_transient_flusher() {
	// Like, beat it. Dig?
	delete_transient( 'all_the_cool_cats' );
}
add_action( 'edit_category', 'planet3_0_category_transient_flusher' );
add_action( 'save_post', 'planet3_0_category_transient_flusher' );